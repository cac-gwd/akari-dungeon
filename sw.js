const PREFIX='akari-'+self.registration.scope, CACHE=PREFIX+'v1.2.0';
const FILES=['./','./index.html','./style.css','./app.js','./engine.js','./dungeon.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
